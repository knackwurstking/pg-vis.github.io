...
<slot></slot>
`,at=class at extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ze,this.cleanup=new g}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(at,"register",()=>{customElements.get("ui-container")||customElements.define("ui-container",at)});let Pt=at;const je=c`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,gt=class gt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Je}};a(gt,"register",()=>{customElements.get("svg-menu")||customElements.define("svg-menu",gt)});let Ot=gt;const Ze=c`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`;var S,w,E,ae;let Xe=(ae=class{constructor(t,e){f(this,S,void 0);f(this,w,void 0);f(this,E,void 0);b(this,S,t),b(this,w,e),this.events=new L,b(this,E,document.createElement("h4")),n(this,E).slot="title",n(this,S).appendChild(n(this,E))}get fullscreen(){return n(this,S).hasAttribute("fullscreen")}set fullscreen(t){t?n(this,S).setAttribute("fullscreen",""):n(this,S).removeAttribute("fullscreen")}get title(){return n(this,E).innerText}set title(t){n(this,E).innerText=t}getDialogElement(){return n(this,w)}open(t=!1,e=!0){const i=n(this,w).inert;n(this,w).inert=e,t?n(this,w).showModal():n(this,w).show(),this.events.dispatch("open",null),n(this,w).inert=i}close(){n(this,w).close(),this.events.dispatch("close",null)}},S=new WeakMap,w=new WeakMap,E=new WeakMap,ae);const ft=class ft extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=We,this.cleanup=new g,this.ui=new Xe(this,this.shadowRoot.querySelector("dialog"))}connectedCallback(){const t=this.shadowRoot.querySelector(".header ui-icon-button"),e=()=>{this.ui.close()};t.addEventListener("click",e);const i=this.shadowRoot.querySelector("dialog"),s=r=>{r.preventDefault()};i.addEventListener("cancel",s),this.cleanup.add(()=>{t.removeEventListener("click",e),i.removeEventListener("cancel",s)})}disconnectedCallback(){this.cleanup.run()}};a(ft,"register",()=>{Y.register(),jt.register(),W.register(),customElements.get("ui-dialog")||customElements.define("ui-dialog",ft)});let Jt=ft;const re=150,he=document.createElement("template");he.innerHTML=`
    <style>
        * { box-sizing: border-box; }
...
<slot></slot>
`,bt=class bt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ke,this.cleanup=new g}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(bt,"register",()=>{customElements.get("ui-primary")||customElements.define("ui-primary",bt)});let U=bt;const Qe=c`
<style>
    :host {
        font-size: 0.9rem;
        font-family: var(--ui-fontFamily);
...
<slot></slot>
`,vt=class vt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Qe,this.cleanup=new g}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(vt,"register",()=>{customElements.get("ui-secondary")||customElements.define("ui-secondary",vt)});let R=vt;const de=document.createElement("template");de.innerHTML=`
    <style>
        * { box-sizing: border-box; }
...
`;let _e=class{constructor(t){this.root=t,this.outside=this.root.querySelector(".outside"),this.aside=this.root.shadowRoot.querySelector("aside")}get title(){return this.root.getAttribute("title")||null}set title(t){t?this.root.setAttribute("title",t):this.root.removeAttribute("title")}setTitle(t){let e=this.root.shadowRoot.querySelector(".ui-drawer-group-title");e.classList.add("visible"),e.innerHTML=`
        ...
        `}removeTitle(){this.root.shadowRoot.querySelector(".ui-drawer-group-title").classList.remove("visible")}};const O=class O extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(pe.content.cloneNode(!0)),this.cleanup=new g,this.ui=new _e(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"title":i===""?this.removeAttribute("title"):i!==null?this.ui.setTitle(i):this.ui.removeTitle();break}}};a(O,"register",()=>{K.register(),U.register(),customElements.get("ui-drawer-group")||customElements.define("ui-drawer-group",O)}),a(O,"observedAttributes",["title"]);let Wt=O;const ge=document.createElement("template");ge.innerHTML=`
    <style>
        :host {
            display: block;
            position: relative;
...
`;let ti=class{constructor(t){this.root=t,this.events=new L,this.input=this.root.shadowRoot.querySelector("input"),this.input.type=this.root.getAttribute("type")||"text",this.input.oninput=()=>this.events.dispatch("input",this.value),this.input.onchange=()=>this.events.dispatch("change",this.value)}set title(t){let e=this.root.querySelector('[slot="title"]');t===null&&e&&(this.root.removeChild(e),e=null),e||(e=new R,e.slot="title",this.root.appendChild(e)),e.innerHTML=t||""}get title(){var t;return((t=this.root.querySelector('[slot="title"]'))==null?void 0:t.innerHTML)||null}set type(t){this.input.type=t}get type(){return this.input.type||"text"}set value(t){this.input.value=t}get value(){switch(this.input.type){case"number":return this.input.value?new Number(this.input.value):NaN;default:return this.input.value}}set placeholder(t){this.input.placeholder=t}get placeholder(){return this.input.placeholder}set invalid(t){this.input.ariaInvalid=t?"":null}get invalid(){return this.input.ariaInvalid!==null}set min(t){this.input.min=t}get min(){switch(this.input.type){case"number":return this.input.min?new Number(this.input.min):NaN;default:return this.input.min}}set max(t){this.input.max=t}get max(){switch(this.input.type){case"number":return this.input.max?new Number(this.input.max):NaN;default:return this.input.max}}};const V=class V extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(ge.content.cloneNode(!0)),this.cleanup=new g,this.ui=new ti(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"title":this.ui.title=i;break;case"type":i===null?this.ui.type="text":this.ui.type=i;break;case"value":this.ui.value=this.parseNewValue(i);break;case"placeholder":i===null?this.ui.placeholder="":this.ui.placeholder=i;break;case"invalid":this.ui.invalid=i!==null;break;case"min":this.ui.min=this.parseNewValue(i);break;case"max":this.ui.max=this.parseNewValue(i);break}}parseNewValue(t){switch(this.ui.type){case"number":return t?new Number(t):NaN;default:return t||""}}};a(V,"register",()=>{R.register(),customElements.get("ui-input")||customElements.define("ui-input",V)}),a(V,"observedAttributes",["title","type","value","placeholder","invalid","min","max"]);let Xt=V;const ei=c`
    <style>
        * { box-sizing: border-box; }
...
`;let ii=class{constructor(t){this.root=t,this.events=new L,this.submit=this.root.shadowRoot.querySelector("ui-icon-button"),this.submit.ui.events.on("click",()=>{this.events.dispatch("submit",this.value)}),this.input=this.root.shadowRoot.querySelector("input"),this.input.type="text",this.input.onkeydown=e=>{e.key==="Enter"&&this.submit.click()}}set title(t){t===null?this.root.removeAttribute("title"):this.root.setAttribute("title",t)}get title(){return this.root.getAttribute("title")}set value(t){this.input.value=t}get value(){return this.input.value}set placeholder(t){this.input.placeholder=t}get placeholder(){return this.input.placeholder}set invalid(t){t?this.root.setAttribute("invalid",""):this.root.removeAttribute("invalid")}get invalid(){return this.input.ariaInvalid!==null}};const J=class J extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ei,this.cleanup=new g,this.ui=new ii(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"title":let s=this.querySelector('[slot="title"]');i===null&&s&&(this.removeChild(s),s=null),s||(s=new R,s.slot="title",this.appendChild(s)),s.innerHTML=i||"";break;case"value":this.ui.value=i||"";break;case"placeholder":i===null?this.ui.placeholder="":this.ui.placeholder=i;break;case"invalid":this.ui.input.ariaInvalid=i!==null?"":null;break}}};a(J,"register",()=>{R.register(),Y.register(),Ft.register(),customElements.get("ui-search")||customElements.define("ui-search",J)}),a(J,"observedAttributes",["title","value","placeholder","invalid"]);let Yt=J;const si=c`
    ...
    <slot></slot>
`;var q,le;let ri=(le=class{constructor(t){f(this,q,void 0);b(this,q,t)}get name(){return n(this,q).getAttribute("name")}set name(t){n(this,q).setAttribute("name",t)}},q=new WeakMap,le);const wt=class wt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=si,this.cleanup=new g,this.ui=new ri(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(wt,"register",()=>{customElements.get("ui-stack-layout-page")||customElements.define("ui-stack-layout-page",wt)});let M=wt;const oi=c`
    <style>
        :host {
            display: block !important;
            position: relative !important;
...
`,Lt=class Lt extends M{constructor(t){super(),this.innerHTML=hi,this.className="no-scrollbar",this.style.paddingTop="calc(var(--ui-app-bar-height) + var(--ui-spacing))",this.style.overflow="auto",this.ui.name="alert",this.events=new L,this.alert=null,this.uiStore=t}connectedCallback(){super.connectedCallback(),this.shareBackup=this.uiStore.ui.get("share"),this.uiStore.ui.set("share",null),this.cleanup.add(()=>{this.uiStore.ui.set("share",this.shareBackup)})}set(t){this.alert=t;let e=this.querySelector("ui-flex-grid-item.alert");for(;e.firstChild;)e.removeChild(e.firstChild);if(t===null)return;for(e.appendChild(me({alert:t,container:"div",hasRipple:!1})),e=this.querySelector("ui-flex-grid-item.desc");e.firstChild;)e.removeChild(e.firstChild);for(e.appendChild(ui({alert:t})),e=this.querySelector("ui-flex-grid-item.note");e.firstChild;)e.removeChild(e.firstChild);let i=null;e.appendChild(ci({alert:t,onInput:async s=>{const r=s.currentTarget.value;i!==null&&clearTimeout(i),i=setTimeout(()=>{this.alert.note=r},250)}}))}};a(Lt,"register",()=>{D.register(),X.register(),H.register(),customElements.define("alert-page",Lt)});let et=Lt;const oe="3.5em",di=c`
    <div
        class="no-scrollbar"
        style="
            width: 100%;
...
`),note:t.getAttribute("data-note")}}is(t,e){return!!`${t.from}..${t.to} ${t.alert}`.match(e)}async onClick(t){const e=t.currentTarget,i=this.getAlertFromLI(e);this.pages.alert.set(i),this.stackLayout.ui.setPage(this.pages.alert.ui.name,!0)}};a(St,"register",()=>{D.register(),Yt.register(),_.register(),et.register(),customElements.define("alert-lists-page",St)});let it=St;const pi=c`
`,Et=class Et extends M{constructor(){super(),this.innerHTML=pi,this.ui.name="metal-sheet-lists"}};a(Et,"register",()=>{customElements.define("metal-sheet-lists-page",Et)});let st=Et;const gi=c`
`,At=class At extends M{constructor(){super(),this.innerHTML=gi,this.ui.name="vis"}};a(At,"register",()=>{customElements.define("vis-page",At)});let rt=At;const mi=c`
`,Mt=class Mt extends M{constructor(){super(),this.innerHTML=mi,this.ui.name="vis-data"}};a(Mt,"register",()=>{customElements.define("vis-data-page",Mt)});let ot=Mt;const fi=c`
    <ui-store
