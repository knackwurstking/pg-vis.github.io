...
<slot></slot>
`,ct=class ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Fe,this.cleanup=new h,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(ct,"register",()=>{customElements.get("ui-container")||customElements.define("ui-container",ct)});let Gt=ct;const Oe=a`
    <style>
        :host {
            width: 100%;
            height: 100%;
...
`,ut=class ut extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Oe}};n(ut,"register",()=>{customElements.get("svg-chevron-left")||customElements.define("svg-chevron-left",ut)});let It=ut;const Pe=a`
    <style>
        :host {
            width: 100%;
            height: 100%;
...
`,O=class O extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ue,this.cleanup=new h,this.ui={root:this,getTitle(){return this.root.getAttribute("title")||null},setTitle(t){let e=this.root.shadowRoot.querySelector(".ui-drawer-group-title");e.classList.add("visible"),e.innerHTML=`
                    <span
                        style="
                            font-size: 1.5rem;
                            font-weight: 600;
...
`,Ft=class Ft extends X{constructor(){super(),this.innerHTML=Si}getGroup(t){return this.querySelector(`pg-drawer-${t.toString()}`)}};n(Ft,"register",()=>{X.register(),ne.register(),ae.register(),le.register(),ce.register(),customElements.define("pg-drawer",Ft)});let ue=Ft;const Li=a`
