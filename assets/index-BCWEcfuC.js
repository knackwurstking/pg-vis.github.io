...
`;let xe=class{constructor(t){this.root=t}get gap(){return this.root.getAttribute("gap")||Ht}set gap(t){t===null?this.root.removeAttribute("gap"):this.root.setAttribute("gap",t)}};const B=class B extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ke,this.cleanup=new g,this.ui=new xe(this),this.updateStyle()}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"gap":this.updateStyle({gap:i||Ht});break}}updateStyle({gap:t=Ht}={}){this.shadowRoot.querySelector("style").textContent=`
        ...
        `}};a(B,"register",()=>{customElements.get("ui-flex-grid-row")||customElements.define("ui-flex-grid-row",B)}),a(B,"observedAttributes",["gap"]);let W=B;const $t="0",Le=u`
<style></style>
<slot></slot>
`;let Ce=class{constructor(t){this.root=t}get gap(){return this.root.getAttribute("gap")||$t}set gap(t){t===null?this.root.removeAttribute("gap"):this.root.setAttribute("gap",t)}};const P=class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Le,this.cleanup=new g,this.ui=new Ce(this),this.updateStyle()}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"gap":this.updateStyle({gap:i||$t});break}}updateStyle({gap:t=$t}={}){this.shadowRoot.querySelector("style").textContent=`
            :host {
                display: flex !important;
        ...
        `}};a(P,"register",()=>{customElements.get("ui-flex-grid")||customElements.define("ui-flex-grid",P)}),a(P,"observedAttributes",["gap"]);let Q=P;const Se=u`
<style>
...
`;var H,oe;let Ee=(oe=class{constructor(t){b(this,H,void 0);v(this,H,t)}getLeftSlot(){return[...n(this,H).querySelectorAll('[slot="left"]')]}getCenterSlot(){return[...n(this,H).querySelectorAll('[slot="center"]')]}getRightSlot(){return[...n(this,H).querySelectorAll('[slot="right"]')]}},H=new WeakMap,oe);const rt=class rt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Se,this.cleanup=new g,this.ui=new Ee(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(rt,"register",()=>{W.register(),customElements.get("ui-app-bar")||customElements.define("ui-app-bar",rt)});let Rt=rt;const Me=u`
<style>
    * { box-sizing: border-box; }
...
<slot></slot>
`;let He=class{constructor(t){this.root=t,this.removeRipple=null,this.events=new T,this.root.onclick=()=>this.events.dispatch("click",this.root)}get color(){return this.root.getAttribute("color")}set color(t){this.root.setAttribute("color",t)}get ghost(){return this.root.hasAttribute("ghost")}set ghost(t){t?this.root.setAttribute("ghost",""):this.root.removeAttribute("ghost")}disable(){this.root.setAttribute("disabled","")}enable(){this.root.removeAttribute("disabled")}enableRipple(){this.removeRipple||(this.removeRipple=Qt(this.root,{centered:!0}),this.root.removeAttribute("no-ripple"))}disableRipple(){this.removeRipple&&(this.removeRipple(),this.removeRipple=null,this.root.setAttribute("no-ripple",""))}};const I=class I extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Te,this.setAttribute("role","button"),this.cleanup=new g,this.ui=new He(this)}connectedCallback(){!this.hasAttribute("no-ripple")&&!this.ui.removeRipple&&this.ui.enableRipple()}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"no-ripple":i!==null?this.ui.disableRipple():this.ui.enableRipple();break;case"color":i!==null&&(["primary","secondary","destructive"].includes(i)?this.style.color=null:this.style.color=i);break}}};a(I,"register",()=>{customElements.get("ui-icon-button")||customElements.define("ui-icon-button",I)}),a(I,"observedAttributes",["no-ripple","color"]);let X=I;const $e=u`
<style>
    * { box-sizing: border-box; }
...
<slot></slot>
`,ot=class ot extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=$e,this.cleanup=new g}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(ot,"register",()=>{customElements.get("ui-container")||customElements.define("ui-container",ot)});let qt=ot;const Re=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,nt=class nt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Re}};a(nt,"register",()=>{customElements.get("svg-add")||customElements.define("svg-add",nt)});let Nt=nt;const qe=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,at=class at extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=qe}};a(at,"register",()=>{customElements.get("svg-back-arrow")||customElements.define("svg-back-arrow",at)});let Dt=at;const Ne=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,lt=class lt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ne}};a(lt,"register",()=>{customElements.get("svg-close")||customElements.define("svg-close",lt)});let zt=lt;const De=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ct=class ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=De}};a(ct,"register",()=>{customElements.get("svg-edit")||customElements.define("svg-edit",ct)});let jt=ct;const ze=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ut=class ut extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=ze}};a(ut,"register",()=>{customElements.get("svg-recycle")||customElements.define("svg-recycle",ut)});let Bt=ut;const je=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ht=class ht extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=je}};a(ht,"register",()=>{customElements.get("svg-search")||customElements.define("svg-search",ht)});let Pt=ht;const Be=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,dt=class dt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Be}};a(dt,"register",()=>{customElements.get("svg-menu")||customElements.define("svg-menu",dt)});let Ft=dt;const Pe=u`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,pt=class pt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Pe}};a(pt,"register",()=>{customElements.get("svg-share")||customElements.define("svg-share",pt)});let It=pt;const Fe=u`
<style>
    * { box-sizing: border-box; }
...
`;var E,y,M,ne;let Ie=(ne=class{constructor(t,e){b(this,E,void 0);b(this,y,void 0);b(this,M,void 0);v(this,E,t),v(this,y,e),this.events=new T,v(this,M,document.createElement("h4")),n(this,M).slot="title",n(this,E).appendChild(n(this,M))}get fullscreen(){return n(this,E).hasAttribute("fullscreen")}set fullscreen(t){t?n(this,E).setAttribute("fullscreen",""):n(this,E).removeAttribute("fullscreen")}get title(){return n(this,M).innerText}set title(t){n(this,M).innerText=t}getDialogElement(){return n(this,y)}open(t=!1,e=!0){const i=n(this,y).inert;n(this,y).inert=e,t?n(this,y).showModal():n(this,y).show(),this.events.dispatch("open",null),n(this,y).inert=i}close(){n(this,y).close(),this.events.dispatch("close",null)}},E=new WeakMap,y=new WeakMap,M=new WeakMap,ne);const mt=class mt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Fe,this.cleanup=new g,this.ui=new Ie(this,this.shadowRoot.querySelector("dialog"))}connectedCallback(){const t=this.shadowRoot.querySelector(".header ui-icon-button"),e=()=>{this.ui.close()};t.addEventListener("click",e);const i=this.shadowRoot.querySelector("dialog"),s=o=>{o.preventDefault()};i.addEventListener("cancel",s),this.cleanup.add(()=>{t.removeEventListener("click",e),i.removeEventListener("cancel",s)})}disconnectedCallback(){this.cleanup.run()}};a(mt,"register",()=>{X.register(),zt.register(),W.register(),customElements.get("ui-dialog")||customElements.define("ui-dialog",mt)});let Vt=mt;const ie=150,ue=document.createElement("template");ue.innerHTML=`
    <style>
        * { box-sizing: border-box; }
...
<slot></slot>
`,gt=class gt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Oe,this.cleanup=new g}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(gt,"register",()=>{customElements.get("ui-primary")||customElements.define("ui-primary",gt)});let Gt=gt;const Ge=u`
<style>
    :host {
        font-size: 0.9rem;
        font-family: var(--ui-fontFamily);
...
<slot></slot>
`,ft=class ft extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ge,this.cleanup=new g}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(ft,"register",()=>{customElements.get("ui-secondary")||customElements.define("ui-secondary",ft)});let z=ft;const he=document.createElement("template");he.innerHTML=`
    <style>
        * { box-sizing: border-box; }
...
`;let Je=class{constructor(t){this.root=t,this.outside=this.root.querySelector(".outside"),this.aside=this.root.shadowRoot.querySelector("aside")}get title(){return this.root.getAttribute("title")||null}set title(t){t?this.root.setAttribute("title",t):this.root.removeAttribute("title")}setTitle(t){let e=this.root.shadowRoot.querySelector(".ui-drawer-group-title");e.classList.add("visible"),e.innerHTML=`
            <span
                style="
                    font-size: 1.5rem;
                    font-weight: 600;
...
`;let We=class{constructor(t){this.root=t,this.events=new T,this.input=this.root.shadowRoot.querySelector("input"),this.input.type=this.root.getAttribute("type")||"text",this.input.oninput=()=>this.events.dispatch("input",this.value),this.input.onchange=()=>this.events.dispatch("change",this.value)}set title(t){let e=this.root.querySelector('[slot="title"]');t===null&&e&&(this.root.removeChild(e),e=null),e||(e=new z,e.slot="title",this.root.appendChild(e)),e.innerHTML=t||""}get title(){var t;return((t=this.root.querySelector('[slot="title"]'))==null?void 0:t.innerHTML)||null}set type(t){this.input.type=t}get type(){return this.input.type||"text"}set value(t){this.input.value=t}get value(){switch(this.input.type){case"number":return this.input.value?new Number(this.input.value):NaN;default:return this.input.value}}set placeholder(t){this.input.placeholder=t}get placeholder(){return this.input.placeholder}set invalid(t){this.input.ariaInvalid=t?"":null}get invalid(){return this.input.ariaInvalid!==null}set min(t){this.input.min=t}get min(){switch(this.input.type){case"number":return this.input.min?new Number(this.input.min):NaN;default:return this.input.min}}set max(t){this.input.max=t}get max(){switch(this.input.type){case"number":return this.input.max?new Number(this.input.max):NaN;default:return this.input.max}}};const G=class G extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(pe.content.cloneNode(!0)),this.cleanup=new g,this.ui=new We(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"title":this.ui.title=i;break;case"type":i===null?this.ui.type="text":this.ui.type=i;break;case"value":this.ui.value=this.parseNewValue(i);break;case"placeholder":i===null?this.ui.placeholder="":this.ui.placeholder=i;break;case"invalid":this.ui.invalid=i!==null;break;case"min":this.ui.min=this.parseNewValue(i);break;case"max":this.ui.max=this.parseNewValue(i);break}}parseNewValue(t){switch(this.ui.type){case"number":return t?new Number(t):NaN;default:return t||""}}};a(G,"register",()=>{z.register(),customElements.get("ui-input")||customElements.define("ui-input",G)}),a(G,"observedAttributes",["title","type","value","placeholder","invalid","min","max"]);let Jt=G;const Xe=u`
    <style>
        * { box-sizing: border-box; }
...
`;let Ye=class{constructor(t){this.root=t,this.events=new T,this.submit=this.root.shadowRoot.querySelector("ui-icon-button"),this.submit.ui.events.on("click",()=>{this.events.dispatch("submit",this.value)}),this.input=this.root.shadowRoot.querySelector("input"),this.input.type="text",this.input.onkeydown=e=>{e.key==="Enter"&&this.submit.click()}}set title(t){t===null?this.root.removeAttribute("title"):this.root.setAttribute("title",t)}get title(){return this.root.getAttribute("title")}set value(t){this.input.value=t}get value(){return this.input.value}set placeholder(t){this.input.placeholder=t}get placeholder(){return this.input.placeholder}set invalid(t){t?this.root.setAttribute("invalid",""):this.root.removeAttribute("invalid")}get invalid(){return this.input.ariaInvalid!==null}};const Z=class Z extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Xe,this.cleanup=new g,this.ui=new Ye(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"title":let s=this.querySelector('[slot="title"]');i===null&&s&&(this.removeChild(s),s=null),s||(s=new z,s.slot="title",this.appendChild(s)),s.innerHTML=i||"";break;case"value":this.ui.value=i||"";break;case"placeholder":i===null?this.ui.placeholder="":this.ui.placeholder=i;break;case"invalid":this.ui.input.ariaInvalid=i!==null?"":null;break}}};a(Z,"register",()=>{z.register(),X.register(),Pt.register(),customElements.get("ui-search")||customElements.define("ui-search",Z)}),a(Z,"observedAttributes",["title","value","placeholder","invalid"]);let Wt=Z;const Ke=u`
    ...
    <slot></slot>
`;var N,ae;let Qe=(ae=class{constructor(t){b(this,N,void 0);v(this,N,t)}get name(){return n(this,N).getAttribute("name")}set name(t){n(this,N).setAttribute("name",t)}},N=new WeakMap,ae);const vt=class vt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ke,this.cleanup=new g,this.ui=new Qe(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(vt,"register",()=>{customElements.get("ui-stack-layout-page")||customElements.define("ui-stack-layout-page",vt)});let R=vt;const Ue=u`
    <style>
        :host {
            display: block !important;
            position: relative !important;
    ...
    <slot></slot>
`;var A,$,D,le;let _e=(le=class{constructor(t){b(this,A,void 0);b(this,$,!1);b(this,D,{});v(this,A,t),this.events=new T,this.stack=[]}registerPage(t,e){n(this,D)[t]=e}unregisterPage(t){delete n(this,D)[t]}lock(){v(this,$,!0)}unlock(){v(this,$,!1)}clearStack(){for(;this.stackSize()>0;)n(this,A).removeChild(this.stack.pop())}stackSize(){return this.stack.length}goBack(){if(!this.stack.length||n(this,$))return;const t=this.stack.pop(),e=n(this,A).removeChild(t);this.stack.length&&n(this,A).appendChild(this.stack[this.stack.length-1]),this.dispatchChangeEvent(e)}setPage(t){if(!n(this,$)){if(this.stack.push(n(this,A).appendChild(n(this,D)[t]())),this.stack.length>1){const e=this.stack[this.stack.length-2];e.parentElement.removeChild(e)}this.dispatchChangeEvent(null)}}async dispatchChangeEvent(t){this.events.dispatch("change",{newPage:this.stack[this.stack.length-1]||null,oldPage:t||this.stack[this.stack.length-2]||null})}},A=new WeakMap,$=new WeakMap,D=new WeakMap,le);const wt=class wt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ue,this.cleanup=new g,this.ui=new _e(this)}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(wt,"register",()=>{R.register(),customElements.get("ui-stack-layout")||customElements.define("ui-stack-layout",wt)});let Xt=wt;var C,S,ce;let ti=(ce=class{constructor(t){b(this,C,void 0);b(this,S,{});v(this,C,t),this.events=new T}get localStoragePrefix(){return n(this,C).getAttribute("local-storage-prefix")}set localStoragePrefix(t){n(this,C).setAttribute("local-storage-prefix",t)}get enableLocalStorage(){return n(this,C).hasAttribute("enable-local-storage")}set enableLocalStorage(t){t?n(this,C).setAttribute("enable-local-storage",""):n(this,C).removeAttribute("enable-local-storage")}get(t){return n(this,S)[t]}set(t,e,i=!1){if(i&&this.enableLocalStorage){const s=JSON.parse(localStorage.getItem(this.localStoragePrefix+t.toString())||"null");n(this,S)[t]=s??e}else n(this,S)[t]=e;this.enableLocalStorage&&localStorage.setItem(this.localStoragePrefix+t.toString(),JSON.stringify(n(this,S)[t])),this.events.dispatch(t,n(this,S)[t])}update(t,e){if(typeof e!="function")throw"callback is not a function";this.set(t,e(n(this,S)[t]))}on(t,e,i=!1){if(typeof e!="function")throw"callback is not a function";return i&&e(this.get(t)),this.events.on(t,e)}},C=new WeakMap,S=new WeakMap,ce);const yt=class yt extends HTMLElement{constructor(){super(),this.ui=new ti(this)}};a(yt,"register",()=>{customElements.get("ui-store")||customElements.define("ui-store",yt)});let K=yt;var k;class ei{constructor(){b(this,k,null);this.currentTheme=null,this.themes={}}enableAutoMode(){if(this.removeMode(),n(this,k)){this.mediaChangeHandler(n(this,k));return}v(this,k,window.matchMedia("(prefers-color-scheme: dark)")),n(this,k).addEventListener("change",this.mediaChangeHandler),this.mediaChangeHandler(n(this,k))}disableAutoMode(){this.removeMedia()}addTheme(t,e){this.themes[t]=e}loadTheme(t){var i;if(!this.themes[t])throw`theme "${t}" is missing in this.themes`;if(((i=this.currentTheme)==null?void 0:i.name)==t)return;{const s=document.getElementById("theme");s&&(document.head.removeChild(s),this.currentTheme=null)}const e=document.createElement("link");e.id="theme",e.rel="stylesheet",e.href=this.themes[t],document.head.appendChild(e),this.currentTheme={name:t,href:this.themes[t]}}mediaChangeHandler(t){t.matches?document.body.setAttribute("data-theme","dark"):document.body.setAttribute("data-theme","light")}removeMode(t=document.body){t.removeAttribute("data-theme")}setMode(t,e=document.body){switch(t){case"dark":e.setAttribute("data-theme",t);break;case"light":e.setAttribute("data-theme",t);break}}removeMedia(){n(this,k)&&(n(this,k).removeEventListener("change",this.mediaChangeHandler),v(this,k,null))}}k=new WeakMap;const J=class J extends HTMLElement{constructor(){super(),this.ui=new ei}attributeChangedCallback(t,e,i){switch(t){case"auto":i!==null?this.ui.enableAutoMode():this.ui.disableAutoMode();break;case"mode":i!==null?this.ui.setMode(i):this.ui.removeMode();break}}};a(J,"register",()=>{customElements.get("ui-theme-handler")||customElements.define("ui-theme-handler",J)}),a(J,"observedAttributes",["auto","mode"]);let Yt=J;const kt=class kt extends Vt{constructor(){super(),this.ui.title="New Vis Data",this.uiStore=document.querySelector("ui-store"),this.name,this.createContent(),this.createActions()}connectedCallback(){super.connectedCallback(),this.resets()}resets(){this.name&&(this.name.ui.invalid=!1,this.name.ui.value="")}createContent(){const t=new Q;t.ui.gap="0.5",t.innerHTML=`
            <ui-flex-grid-item>
                <ui-input
                    name="title"
                    type="text"
...
`)}}is(t,e){return!!`${t.from}..${t.to} ${t.alert}`.match(e)}async onClick(t){const e=t.currentTarget,i=this.getAlertFromLI(e);console.warn(i)}};a(xt,"register",()=>{K.register(),Wt.register(),customElements.define("alert-lists-page",xt)});let tt=xt;const si=u`
`,Lt=class Lt extends R{constructor(){super(),this.innerHTML=si,this.ui.name="metal-sheet-lists"}};a(Lt,"register",()=>{customElements.define("metal-sheet-lists-page",Lt)});let et=Lt;const ri=u`
`,Ct=class Ct extends R{constructor(){super(),this.innerHTML=ri,this.ui.name="vis"}};a(Ct,"register",()=>{customElements.define("vis-page",Ct)});let it=Ct;const oi=u`
`,St=class St extends R{constructor(){super(),this.innerHTML=oi,this.ui.name="vis-data"}};a(St,"register",()=>{customElements.define("vis-data-page",St)});let st=St;const ni=u`
    <ui-store
