...
`,q=class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Te,this.cleanup=new h,this.ui={root:this,getGap(){return this.root.getAttribute("gap")||Vt},setGap(t){t===null?this.root.removeAttribute("gap"):this.root.setAttribute("gap",t)}},this.updateStyle()}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"gap":this.updateStyle({gap:i||Vt});break}}updateStyle({gap:t=Vt}={}){this.shadowRoot.querySelector("style").textContent=`
        ...
        `}};n(q,"register",()=>{customElements.get("ui-flex-grid-row")||customElements.define("ui-flex-grid-row",q)}),n(q,"observedAttributes",["gap"]);let A=q;const Jt="0",Me=`
    <style></style>
    <slot></slot>
`,N=class N extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Me,this.cleanup=new h,this.ui={root:this,getGap(){return this.root.getAttribute("gap")||Jt},setGap(t){t===null?this.root.removeAttribute("gap"):this.root.setAttribute("gap",t)}},this.updateStyle()}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"gap":this.updateStyle({gap:i||Jt});break}}updateStyle({gap:t=Jt}={}){this.shadowRoot.querySelector("style").textContent=`
            :host {
                display: flex !important;
        ...
        `}};n(N,"register",()=>{customElements.get("ui-flex-grid")||customElements.define("ui-flex-grid",N)}),n(N,"observedAttributes",["gap"]);let J=N;const $e=a`
    <style>
...
`,rt=class rt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=$e,this.cleanup=new h,this.ui={getLeftSlot:()=>[...this.querySelectorAll('[slot="left"]')],getCenterSlot:()=>[...this.querySelectorAll('[slot="center"]')],getRightSlot:()=>[...this.querySelectorAll('[slot="right"]')]}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(rt,"register",()=>{A.register(),customElements.get("ui-app-bar")||customElements.define("ui-app-bar",rt)});let Zt=rt;const He=a`
    ...
    <slot></slot>
`,st=class st extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=He,this.cleanup=new h,this.ui={enable:()=>{this.style.display="flex"},disable:()=>{this.style.display="none"}}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}get item(){return this.querySelector("*")}};n(st,"register",()=>{customElements.get("ui-app-bar-item")||customElements.define("ui-app-bar-item",st)});let Wt=st;const Re=a`
    <style>
        * {
            box-sizing: border-box;
        }
...
<slot></slot>
`,ot=class ot extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ne,this.cleanup=new h,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(ot,"register",()=>{customElements.get("ui-container")||customElements.define("ui-container",ot)});let Yt=ot;const Be=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,nt=class nt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Be}};n(nt,"register",()=>{customElements.get("svg-back-arrow")||customElements.define("svg-back-arrow",nt)});let Xt=nt;const ze=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,lt=class lt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=je}};n(lt,"register",()=>{customElements.get("svg-recycle")||customElements.define("svg-recycle",lt)});let M=lt;const Fe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ct=class ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Fe}};n(ct,"register",()=>{customElements.get("svg-search")||customElements.define("svg-search",ct)});let W=ct;const Pe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ut=class ut extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Pe}};n(ut,"register",()=>{customElements.get("svg-menu")||customElements.define("svg-menu",ut)});let Qt=ut;const Oe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ht=class ht extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Oe}};n(ht,"register",()=>{customElements.get("svg-share")||customElements.define("svg-share",ht)});let Dt=ht;const Ve=a`
    <style>
        * {
            box-sizing: border-box;
        }
...
`,pt=class pt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ze,this.cleanup=new h,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(pt,"register",()=>{customElements.get("ui-primary")||customElements.define("ui-primary",pt)});let T=pt;const We=a`
    ...
    <slot></slot>
`,gt=class gt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=We,this.cleanup=new h,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(gt,"register",()=>{customElements.get("ui-secondary")||customElements.define("ui-secondary",gt)});let x=gt;const Ye=a`
    <style>
        * {
            box-sizing: border-box;
        }
...
`,mt=class mt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ye,this.cleanup=new h,this.ui={root:this,getOpen(){return this.root.hasAttribute("open")},setOpen(t){t?this.root.setAttribute("open",""):this.root.removeAttribute("open")}}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(mt,"register",()=>{customElements.get("ui-drawer-group-item")||customElements.define("ui-drawer-group-item",mt)});let m=mt;const Xe=a`
    <style>
        * {
            box-sizing: border-box;
        }
...
`,F=class F extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Xe,this.cleanup=new h,this.ui={root:this,getTitle(){return this.root.getAttribute("title")||null},setTitle(t){let e=this.root.shadowRoot.querySelector(".ui-drawer-group-title");e.classList.add("visible"),e.innerHTML=`
                    <span
                        style="
                            font-size: 1.5rem;
                            font-weight: 600;
...
`,ft=class ft extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=De,this.cleanup=new h,this.ui={root:this,getName(){return this.root.getAttribute("name")},setName(t){t===null&&this.root.removeAttribute("name"),this.root.setAttribute("name",t)}}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(ft,"register",()=>{customElements.get("ui-stack-layout-page")||customElements.define("ui-stack-layout-page",ft)});let f=ft;const Ge=a`
    ...
    <slot></slot>
`,bt=class bt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ge,this.cleanup=new h,this.ui={root:this,pages:{},stack:[],events:new b,lock:!1,registerPage(t,e){this.pages[t]=e},unregisterPage(t){delete this.pages[t]},clearStack(){for(;this.stackSize()>0;)this.root.removeChild(this.stack.pop())},stackSize(){return this.stack.length},goBack(){if(!this.stack.length||this.lock)return;const t=this.root.removeChild(this.stack.pop());this.stack.length>0&&(this.stack[this.stack.length-1].parentElement||this.root.appendChild(this.stack[this.stack.length-1])),this.dispatchChangeEvent(t)},setPage(t,e=!1){if(this.lock)return;this.stack.push(this.root.appendChild(this.pages[t]()));let i=null;this.stack.length>1&&!e&&(i=this.stack[this.stack.length-2],i.parentElement.removeChild(i)),this.dispatchChangeEvent(i)},async dispatchChangeEvent(t){this.events.dispatch("change",{newPage:this.stack[this.stack.length-1]||null,oldPage:t||this.stack[this.stack.length-2]||null})}}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(bt,"register",()=>{f.register(),customElements.get("ui-stack-layout")||customElements.define("ui-stack-layout",bt)});let X=bt;const vt=class vt extends HTMLElement{constructor(){super(),this.ui={root:this,stores:{},events:new b,getLocalStoragePrefix(){return this.root.getAttribute("local-storage-prefix")},setLocalStoragePrefix(t){if(t===null){this.root.removeAttribute("local-storage-prefix");return}this.root.setAttribute("local-storage-prefix",t)},getEnableLocalStorage(){return this.root.hasAttribute("enable-local-storage")},setEnableLocalStorage(t){if(!t){this.root.removeAttribute("enable-local-storage");return}this.root.setAttribute("enable-local-storage","")},get(t){return this.stores[t]},set(t,e,i=!1){if(i&&this.getEnableLocalStorage()){const r=JSON.parse(localStorage.getItem(this.getLocalStoragePrefix()+t.toString())||"null");this.stores[t]=r??e}else this.stores[t]=e;this.getEnableLocalStorage()&&localStorage.setItem(this.getLocalStoragePrefix()+t.toString(),JSON.stringify(this.stores[t])),this.events.dispatch(t,this.stores[t])},update(t,e){if(typeof e!="function")throw"callback is not a function";this.set(t,e(this.stores[t]))},on(t,e,i=!1){if(typeof e!="function")throw"callback is not a function";return i&&e(this.get(t)),this.events.on(t,e)}}}};n(vt,"register",()=>{customElements.get("ui-store")||customElements.define("ui-store",vt)});let $=vt;const V=class V extends HTMLElement{constructor(){super(),this.ui={media:null,currentTheme:null,themes:{},enableAutoMode(){if(this.removeMode(),this.media){this.mediaChangeHandler(this.media);return}this.media=window.matchMedia("(prefers-color-scheme: dark)"),this.media.addEventListener("change",this.mediaChangeHandler),this.mediaChangeHandler(this.media)},disableAutoMode(){this.removeMedia()},addTheme(t,e){this.themes[t]=e},loadTheme(t){var i;if(!this.themes[t])throw`theme "${t}" is missing in this.themes`;if(((i=this.currentTheme)==null?void 0:i.name)==t)return;{const r=document.getElementById("theme");r&&(document.head.removeChild(r),this.currentTheme=null)}const e=document.createElement("link");e.id="theme",e.rel="stylesheet",e.href=this.themes[t],document.head.appendChild(e),this.currentTheme={name:t,href:this.themes[t]}},mediaChangeHandler(t){t.matches?document.body.setAttribute("data-theme","dark"):document.body.setAttribute("data-theme","light")},removeMode(t=document.body){t.removeAttribute("data-theme")},setMode(t,e=document.body){switch(t){case"dark":e.setAttribute("data-theme",t);break;case"light":e.setAttribute("data-theme",t);break}},removeMedia(){this.media&&(this.media.removeEventListener("change",this.mediaChangeHandler),this.media=null)}}}attributeChangedCallback(t,e,i){switch(t){case"auto":i!==null?this.ui.enableAutoMode():this.ui.disableAutoMode();break;case"mode":i!==null?this.ui.setMode(i):this.ui.removeMode();break}}};n(V,"register",()=>{customElements.get("ui-theme-handler")||customElements.define("ui-theme-handler",V)}),n(V,"observedAttributes",["auto","mode"]);let Ut=V;const ge="4.5em",Ie=a`
    <style>
        * {
            box-sizing: border-box;
        }
...
`,yt=class yt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ie,this.uiStore=document.querySelector("ui-store"),this.cleanup=new h,this.input=this.shadowRoot.querySelector("ui-search")}connectedCallback(){const t=i=>{this.uiStore.ui.update("search",r=>(r.value=i,r))},e=i=>{this.input.ui.getValue()!==i.value&&this.input.ui.setValue(i.value)};this.cleanup.add(this.uiStore.ui.on("search",e)),this.cleanup.add(this.input.ui.events.on("submit",t))}};n(yt,"register",()=>{It.register(),customElements.define("pg-search-bar",yt)});let _t=yt;const Ue=a`
...
`)),s.setAttribute("data-note",o.note||""),s.onclick=r,i&&(ae(s),s.style.cursor="pointer",s.role="button"),s}const _e=a`
...
`,kt=class kt extends f{constructor(){super(),this.innerHTML=_e,this.className="no-scrollbar",this.style.paddingTop="calc(var(--ui-app-bar-height) + var(--ui-spacing))",this.style.overflow="auto",this.ui.setName("alert"),this.events=new b,this.alert=null,this.uiStore=document.querySelector("ui-store")}connectedCallback(){super.connectedCallback(),this.shareBackup=this.uiStore.ui.get("share"),this.uiStore.ui.set("share",null),this.cleanup.add(()=>{this.uiStore.ui.set("share",this.shareBackup)})}set(t){this.alert=t,this.createAlertItem(),this.createDescItem(),this.createNoteItem()}createAlertItem(){const t=this.querySelector("ui-flex-grid-item.alert");for(;t.firstChild;)t.removeChild(t.firstChild);this.alert!==null&&t.appendChild(me({alert:this.alert,container:"div",hasRipple:!1}))}createDescItem(){const t=this.querySelector("ui-flex-grid-item.desc");for(;t.firstChild;)t.removeChild(t.firstChild);if(this.alert===null)return;const e=document.createElement("p");e.style.padding="var(--ui-spacing)",e.innerText=this.alert.desc.join(`
`),t.appendChild(e)}createNoteItem(){const t=this.querySelector("ui-flex-grid-item.note");for(;t.firstChild;)t.removeChild(t.firstChild);if(this.alert===null)return;let e=null;const i=async s=>{const l=s.currentTarget.value;e!==null&&clearTimeout(e),e=setTimeout(()=>{this.alert.note=l},250)},r=document.createElement("textarea");r.style.width="100%",r.style.height="100%",r.style.resize="none",r.value=this.alert.note||"",r.oninput=i,t.appendChild(r)}};n(kt,"register",()=>{$.register(),J.register(),k.register(),f.register(),customElements.define("alert-page",kt)});let K=kt;const ti=a`
    <div
        class="no-scrollbar"
        style="
            width: 100%;
...
`,Et=class Et extends m{constructor(){super(),this.innerHTML=ai,this.ui={...this.ui,events:new b},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)})),this.cleanup.add(e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title,t.user||null)}setText(t,e=null){const i=document.createElement("span");i.innerHTML=a` <ui-primary>${t}</ui-primary> `,e!==null&&(i.innerHTML+=a`<ui-secondary>${e}</ui-secondary>`),this.querySelector("ui-button").appendChild(i)}};n(Et,"register",()=>{M.register(),m.register(),A.register(),k.register(),v.register(),S.register(),T.register(),x.register(),customElements.define("pg-drawer-item-alert-list",Et)});let U=Et;const li=a`
...
`,At=class At extends C{constructor(){super(),this.innerHTML=li,this.uiStore=document.querySelector("ui-store"),this.stackLayout=document.querySelector("ui-stack-layout")}connectedCallback(){super.connectedCallback(),this.cleanup.add(this.uiStore.ui.on("alertLists",this.onAlertLists.bind(this),!0)),this.querySelector('ui-button[name="import"]').ui.events.on("click",this.onClickImport.bind(this))}async onAlertLists(t){if(!t)return;const e=[...this.children].slice(1);for(;e.length>0;)this.removeChild(e.pop());for(const i of oi(t)){const r=new U;r.set(i),r.cleanup.add(r.ui.events.on("click",()=>{this.stackLayout.ui.clearStack(),this.stackLayout.ui.setPage("alert-lists")})),r.cleanup.add(r.ui.events.on("delete",()=>{this.uiStore.ui.update("alertLists",s=>s.filter(l=>!(l.title===i.title&&l.user===i.user)))})),this.appendChild(r)}}onClickImport(){jt(e=>{const i=JSON.parse(e);if(typeof i.title!="string")throw'invalid "title"';if(typeof i.user!="string"&&i.user)throw'invalid "user"';if(i.user||(i.user=null),!Array.isArray(i.data))throw'invalid "data" array';for(let s=0;s<i.data.length;s++){const l=i.data[s];if(typeof l.from!="number"||typeof l.to!="number")throw`data entry (index: ${s}): invalid from/to`;if(typeof l.alert!="string")throw`data entry (index: ${s}): invalid alert`;if(!Array.isArray(l.desc))throw`data entry (index: ${s}): invalid desc array`;if(l.desc.filter(d=>typeof d!="string").length)throw`data entry (index: ${s}): invalid desc`;if(typeof l.note!="string"&&l.note)throw`data entry (index: ${s}): invalid note`}const r=`${i.title}:${i.user}`;if(this.uiStore.ui.get("alertLists").find(s=>`${s.title}:${s.user}`===r)){if(!window.confirm(`Replace data: ${i.title} (user: ${i.user||""})?`))return;this.uiStore.ui.update("alertLists",s=>s.map(l=>`${l.title}:${l.user}`===r?i:l));return}this.uiStore.ui.update("alertLists",s=>[...s,i])})}};n(At,"register",()=>{C.register(),m.register(),v.register(),U.register(),customElements.define("pg-drawer-alert-lists",At)});let ee=At;const ci=a`
    <ui-flex-grid-row>
        <ui-flex-grid-item>
            <ui-button
                style="justify-content: flex-start;"
...
`,Tt=class Tt extends m{constructor(){super(),this.innerHTML=ci,this.ui={...this.ui,events:new b},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)})),this.cleanup.add(e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title,null)}setText(t,e=null){const i=document.createElement("span");i.innerHTML=a` <ui-primary>${t}</ui-primary> `,e!==null&&(i.innerHTML+=a`<ui-secondary>${e}</ui-secondary>`),this.querySelector("ui-button").appendChild(i)}};n(Tt,"register",()=>{M.register(),m.register(),A.register(),k.register(),v.register(),S.register(),T.register(),x.register(),customElements.define("pg-drawer-item-metal-sheet-list",Tt)});let _=Tt;const ui=a`
...
`,$t=class $t extends m{constructor(){super(),this.innerHTML=hi,this.ui={...this.ui,events:new b},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)})),this.cleanup.add(e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title,null)}setText(t,e=null){const i=document.createElement("span");i.innerHTML=a` <ui-primary>${t}</ui-primary> `,e!==null&&(i.innerHTML+=a`<ui-secondary>${e}</ui-secondary>`),this.querySelector("ui-button").appendChild(i)}};n($t,"regsiter",()=>{M.register(),m.register(),A.register(),k.register(),v.register(),S.register(),T.register(),x.register(),customElements.define("pg-drawer-item-vis",$t)});let tt=$t;const di=a`
...
`,Rt=class Rt extends m{constructor(){super(),this.innerHTML=pi,this.ui={...this.ui,events:new b},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)})),this.cleanup.add(e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title,null)}setText(t,e=null){const i=document.createElement("span");i.innerHTML=a` <ui-primary>${t}</ui-primary> `,e!==null&&(i.innerHTML+=a`<ui-secondary>${e}</ui-secondary>`),this.querySelector("ui-button").appendChild(i)}};n(Rt,"regsiter",()=>{M.register(),m.register(),A.register(),k.register(),v.register(),S.register(),T.register(),x.register(),customElements.define("pg-drawer-item-vis-data",Rt)});let et=Rt;const gi=`
    <ui-flex-grid-item>
        <ui-input
            name="title"
            type="text"
...
`,Bt=class Bt extends Z{constructor(){super(),this.innerHTML=fi}getGroup(t){return this.querySelector(`pg-drawer-${t.toString()}`)}};n(Bt,"register",()=>{Z.register(),ee.register(),ie.register(),re.register(),se.register(),customElements.define("pg-drawer",Bt)});let oe=Bt;const bi=a`
    ...
    <pg-drawer></pg-drawer>
`,zt=class zt extends HTMLElement{constructor(){super(),this.innerHTML=bi,this.cleanup=new h,this.uiStore=this.querySelector("ui-store"),this.createStore(),this.pages,this.stackLayout=this.querySelector("ui-stack-layout"),this.createStackLayout(),this.pgSearchBar=this.querySelector("pg-search-bar"),this.pgAppBar=this.querySelector("pg-app-bar"),this.pgDrawer=this.querySelector("pg-drawer")}connectedCallback(){this.pgDrawer.ui.setOpen(!0),this.cleanup.add(this.uiStore.ui.on("appBarTitle",this.onAppBarTitle.bind(this),!0)),this.cleanup.add(this.uiStore.ui.on("share",this.onShare.bind(this),!0)),this.setupNoPage()}disconnectedCallback(){this.cleanup.run()}createStore(){this.uiStore.ui.set("alertLists",[],!0),this.uiStore.ui.set("metalSheetLists",[],!0),this.uiStore.ui.set("vis",[],!0),this.uiStore.ui.set("visData",[],!0),this.uiStore.ui.set("appBarTitle","",!1),this.uiStore.ui.set("share",null,!1),this.uiStore.ui.set("search",{active:!1,value:""},!1)}createStackLayout(){this.stackLayout.ui.events.on("change",({newPage:t})=>{if(this.stackLayout.ui.stackSize()>1?this.pgAppBar.itemBack.ui.enable():this.pgAppBar.itemBack.ui.disable(),!t){this.setupNoPage();return}switch(t.ui.getName()){case"alert-lists":this.setupAlertListsPage();break;case"metal-sheet-lists":break;case"vis":break;case"vis-data":break;case"alert":this.setupAlertPage();break;default:this.setupNoPage()}}),this.stackLayout.ui.registerPage("alert-lists",()=>new Q),this.stackLayout.ui.registerPage("metal-sheet-lists",()=>new D),this.stackLayout.ui.registerPage("vis",()=>new G),this.stackLayout.ui.registerPage("vis-data",()=>new I)}setupAlertPage(){this.pgAppBar.itemSearch.ui.disable()}setupAlertListsPage(){var t;this.uiStore.ui.set("appBarTitle",`${(t=this.pages.alertLists.alertList)==null?void 0:t.title}`),this.pgAppBar.itemSearch.ui.enable()}setupNoPage(){this.uiStore.ui.set("appBarTitle","PG: Vis"),this.uiStore.ui.set("share",null),this.pgAppBar.itemSearch.ui.disable()}async onAppBarTitle(t){this.pgAppBar.itemTitle.item.innerHTML=t||""}async onShare(t){t!==null?this.pgAppBar.itemShare.ui.enable():this.pgAppBar.itemShare.ui.disable()}};n(zt,"register",()=>{M.register(),$.register(),Ut.register(),A.register(),k.register(),Yt.register(),X.register(),Z.register(),C.register(),m.register(),v.register(),S.register(),T.register(),x.register(),_t.register(),te.register(),oe.register(),Q.register(),D.register(),G.register(),I.register(),customElements.define("pg-app",zt)});let ne=zt;Le({onRegistered(o){setTimeout(async()=>{try{await o.update()}catch(t){console.warn(`Auto update failed: ${t}`)}})}});ne.register();
