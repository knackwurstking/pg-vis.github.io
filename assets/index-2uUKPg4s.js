var ye=Object.defineProperty;var we=(o,t,e)=>t in o?ye(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var n=(o,t,e)=>(we(o,typeof t!="symbol"?t+"":t,e),e),ke=(o,t,e)=>{if(!t.has(o))throw TypeError("Cannot "+e)};var E=(o,t,e)=>(ke(o,t,"read from private field"),e?e.call(o):t.get(o)),ce=(o,t,e)=>{if(t.has(o))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(o):t.set(o,e)};(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function e(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=e(r);fetch(r.href,s)}})();const xe="modulepreload",Ce=function(o){return"/pg-vis.github.io/"+o},ue={},Se=function(t,e,i){let r=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));r=Promise.all(e.map(d=>{if(d=Ce(d),d in ue)return;ue[d]=!0;const L=d.endsWith(".css"),p=L?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const g=document.createElement("link");if(g.rel=L?"stylesheet":xe,L||(g.as="script",g.crossOrigin=""),g.href=d,l&&g.setAttribute("nonce",l),document.head.appendChild(g),L)return new Promise((c,u)=>{g.addEventListener("load",c),g.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${d}`)))})}))}return r.then(()=>t()).catch(s=>{const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=s,window.dispatchEvent(l),!l.defaultPrevented)throw s})};function Le(o={}){const{immediate:t=!1,onNeedRefresh:e,onOfflineReady:i,onRegistered:r,onRegisteredSW:s,onRegisterError:l}=o;let d,L;const p=async(c=!0)=>{await L};async function g(){if("serviceWorker"in navigator){if(d=await Se(()=>import("./workbox-window.prod.es5-D5gOYdM7.js"),[]).then(({Workbox:c})=>new c("/pg-vis.github.io/sw.js",{scope:"/pg-vis.github.io/",type:"classic"})).catch(c=>{l==null||l(c)}),!d)return;d.addEventListener("activated",c=>{(c.isUpdate||c.isExternal)&&window.location.reload()}),d.addEventListener("installed",c=>{c.isUpdate||i==null||i()}),d.register({immediate:t}).then(c=>{s?s("/pg-vis.github.io/sw.js",c):r==null||r(c)}).catch(c=>{l==null||l(c)})}}return L=g(),p}var w;class b{constructor(){ce(this,w,{})}on(t,e){if(typeof e!="function")throw`invalid event listener passed for "${t.toString()}" event!`;return E(this,w)[t]||(E(this,w)[t]=[]),E(this,w)[t].push(e),()=>{this.off(t,e)}}off(t,e){if(!E(this,w)[t])throw`no listeners found for ${t.toString()}, there is nothing to delete`;let i=!1,r=0;for(const s of E(this,w)[t])s===e&&(E(this,w)[t].splice(r,1),i=!0),r++;if(!i)throw`listener not found for ${t.toString()}, there is nothing to delete`;return this}dispatch(t,e){if(e===void 0)throw"data is undefined!";if(E(this,w)[t])for(const i of E(this,w)[t])i(e);return this}}w=new WeakMap;function he(o,t){const e=document.createElement("div");e.classList.add("ripple"),e.style.position="absolute",e.style.color="inherit",e.style.borderRadius="50%",e.style.pointerEvents="none",e.style.width="100px",e.style.height="100px",e.style.marginTop="-50px",e.style.marginLeft="-50px",e.style.opacity=`${t.opacity}`,e.style.backgroundColor=t.color,e.style.transform="scale(0) translate(0, 0)",e.style.transition=`transform ${t.spreadDuration} ${t.spreadTiming} 0s,opacity ${t.clearDuration} ${t.clearTiming} 0s`,o.currentTarget.appendChild(e);const i=o.currentTarget.getBoundingClientRect();t.centered?(e.style.top=`${i.height/2}px`,e.style.left=`${i.width/2}px`):(e.style.top=`${o.clientY-i.top}px`,e.style.left=`${o.clientX-i.left}px`);const r=Math.max(i.width,i.height)*.02;return e.style.transform=`scale(${r}) translate(0, 0)`,e}function de(o){o&&(o.addEventListener("transitionend",t=>{t.propertyName==="opacity"&&o.remove()}),o.style.opacity="0")}const Ee={color:"var(--ui-ripple-color, currentColor)",opacity:"var(--ui-ripple-opacity, 0.2)",centered:!1,spreadDuration:".4s",spreadTiming:"linear",clearDuration:"1s",clearTiming:"ease-in-out",useClick:!1};function ae(o,t={}){t={...Ee,...t};let e;const i=s=>{e=he(s,t)},r=()=>{de(e)};return o.classList.add("ripple-container"),o.style.overflow="hidden",t.useClick===!0?o.addEventListener("click",s=>{e=he(s,t),de(e)}):(o.addEventListener("pointerdown",i),o.addEventListener("pointerup",r),o.addEventListener("pointerleave",r)),()=>{o.classList.remove("ripple-container"),o.removeEventListener("pointerdown",i),o.removeEventListener("pointerup",r),o.removeEventListener("pointerleave",r)}}const a=String.raw;class h{constructor(){this.callbacks=[]}add(t){this.callbacks.push(t)}run(){for(let t=0;t<this.callbacks.length;t++)if(this.callbacks[t]!==null)try{this.callbacks[t](),this.callbacks[t]=null}catch(e){console.error("cleanup error:",e)}this.callbacks=this.callbacks.filter(t=>t!==null)}}const Pt="1",Ae=a`
    <style></style>
    <slot></slot>
`,q=class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ae,this.cleanup=new h,this.ui={root:this,getFlex(){return this.root.hasAttribute("flex")?this.root.getAttribute("flex"):Pt},setFlex(t){t===null?this.root.removeAttribute("flex"):this.root.setAttribute("flex",t)}},this.updateStyle()}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"flex":this.updateStyle({flex:i||Pt});break}}updateStyle({flex:t=Pt}={}){this.shadowRoot.querySelector("style").textContent=`
            :host {
                flex: ${t};
            }
        `}};n(q,"register",()=>{customElements.get("ui-flex-grid-item")||customElements.define("ui-flex-grid-item",q)}),n(q,"observedAttributes",["flex"]);let k=q;const Vt="0",Te=`
    <style></style>
    <slot></slot>
...
`,B=class B extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Me,this.cleanup=new h,this.ui={root:this,getGap(){return this.root.getAttribute("gap")||Jt},setGap(t){t===null?this.root.removeAttribute("gap"):this.root.setAttribute("gap",t)}},this.updateStyle()}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"gap":this.updateStyle({gap:i||Jt});break}}updateStyle({gap:t=Jt}={}){this.shadowRoot.querySelector("style").textContent=`
        ...
        `}};n(B,"register",()=>{customElements.get("ui-flex-grid")||customElements.define("ui-flex-grid",B)}),n(B,"observedAttributes",["gap"]);let J=B;const $e=a`
    <style>
...
<slot></slot>
`,ot=class ot extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Be,this.cleanup=new h,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(ot,"register",()=>{customElements.get("ui-container")||customElements.define("ui-container",ot)});let Yt=ot;const Ne=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,nt=class nt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ne}};n(nt,"register",()=>{customElements.get("svg-back-arrow")||customElements.define("svg-back-arrow",nt)});let Xt=nt;const ze=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ct=class ct extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Fe}};n(ct,"register",()=>{customElements.get("svg-search")||customElements.define("svg-search",ct)});let W=ct;const Oe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ut=class ut extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Oe}};n(ut,"register",()=>{customElements.get("svg-menu")||customElements.define("svg-menu",ut)});let Dt=ut;const Pe=a`
<style>
    :host {
        width: 100%;
        height: 100%;
...
`,ht=class ht extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Pe}};n(ht,"register",()=>{customElements.get("svg-share")||customElements.define("svg-share",ht)});let Qt=ht;const Ve=a`
    <style>
        * {
            box-sizing: border-box;
        }
...
`,P=class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=De,this.cleanup=new h,this.ui={root:this,submit:(()=>{const t=this.shadowRoot.querySelector("ui-icon-button");return t.ui.events.on("click",()=>{this.ui.events.dispatch("submit",this.ui.getValue())}),t})(),input:(()=>{const t=this.shadowRoot.querySelector("input");return t.type="text",t.onkeydown=e=>{e.key==="Enter"&&this.ui.submit.click()},t})(),events:new b,setTitle(t){t===null?this.root.removeAttribute("title"):this.root.setAttribute("title",t)},getTitle(){return this.root.getAttribute("title")},setValue(t){if(t===null){this.root.removeAttribute("value");return}this.root.setAttribute("value",t)},getValue(){return this.input.value},setPlaceholder(t){if(t===null){this.root.removeAttribute("placeholder");return}this.root.setAttribute("placeholder",t)},getPlaceholder(){return this.root.getAttribute("placeholder")},setInvalid(t){if(t===null||t===!1){this.root.setAttribute("invalid","");return}this.root.removeAttribute("invalid")},getInvalid(){return this.root.hasAttribute("invalid")}}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"title":let r=this.querySelector('[slot="title"]');i===null&&r&&(this.removeChild(r),r=null),r||(r=new x,r.slot="title",this.appendChild(r)),r.innerHTML=i||"";break;case"value":this.ui.input.value=i||"";break;case"placeholder":this.ui.input.placeholder=i||"";break;case"invalid":this.ui.input.ariaInvalid=i!==null?"":null;break}}};n(P,"register",()=>{x.register(),S.register(),W.register(),customElements.get("ui-search")||customElements.define("ui-search",P)}),n(P,"observedAttributes",["title","value","placeholder","invalid"]);let Gt=P;const Qe=a`
    ...
    <slot></slot>
`,ft=class ft extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Qe,this.cleanup=new h,this.ui={root:this,getName(){return this.root.getAttribute("name")},setName(t){t===null&&this.root.removeAttribute("name"),this.root.setAttribute("name",t)}}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};n(ft,"register",()=>{customElements.get("ui-stack-layout-page")||customElements.define("ui-stack-layout-page",ft)});let f=ft;const Ie=a`
    <style>
        :host {
            display: block !important;
            position: relative !important;
...
`,yt=class yt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ge,this.uiStore=document.querySelector("ui-store"),this.cleanup=new h,this.input=this.shadowRoot.querySelector("ui-search")}connectedCallback(){const t=i=>{this.uiStore.ui.update("search",r=>(r.value=i,r))},e=i=>{this.input.ui.getValue()!==i.value&&this.input.ui.setValue(i.value)};this.cleanup.add(this.uiStore.ui.on("search",e)),this.cleanup.add(this.input.ui.events.on("submit",t))}};n(yt,"register",()=>{Gt.register(),customElements.define("pg-search-bar",yt)});let _t=yt;const Ue=a`
...
`,wt=class wt extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=Ue,this.cleanup=new h,this.uiStore=document.querySelector("ui-store"),this.uiDrawer=document.querySelector("pg-drawer"),this.stackLayout=document.querySelector("ui-stack-layout"),this.pgSearchBar=document.querySelector("pg-search-bar"),this.itemMenu=this.shadowRoot.querySelector('[name="menu"]'),this.itemBack=this.shadowRoot.querySelector('[name="back"]'),this.itemTitle=this.shadowRoot.querySelector('[name="title"]'),this.itemShare=this.shadowRoot.querySelector('[name="share"]'),this.itemSearch=this.shadowRoot.querySelector('[name="search"]')}connectedCallback(){this.cleanup.add(this.itemMenu.ui.getItem().ui.events.on("click",async()=>this.uiDrawer.ui.setOpen(!0))),this.cleanup.add(this.itemBack.ui.getItem().ui.events.on("click",()=>this.stackLayout.ui.goBack())),this.cleanup.add(this.itemShare.ui.getItem().ui.events.on("click",async()=>{const t=this.uiStore.ui.get("share");if(!navigator.canShare){const e=document.createElement("a");for(const i of t.files)e.download=i.name,e.href="data:text/json;charset=utf-8,"+encodeURIComponent(await i.text()),e.click();return}navigator.canShare(t)&&await navigator.share(t)})),this.cleanup.add(this.itemSearch.ui.getItem().ui.events.on("click",()=>{if(this.pgSearchBar.style.display==="block"){this.pgSearchBar.style.display="none",this.stackLayout.parentElement.style.setProperty("--search-bar-height","0rem"),this.uiStore.ui.update("search",t=>(t.active=!1,t));return}this.pgSearchBar.style.display="block",this.pgSearchBar.input.ui.input.focus(),this.stackLayout.parentElement.style.setProperty("--search-bar-height",ge),this.uiStore.ui.update("search",t=>(t.active=!0,t))}))}disconnectedCallback(){this.cleanup.run()}};n(wt,"register",()=>{W.register(),Qt.register(),Xt.register(),Dt.register(),Wt.register(),Zt.register(),m.register(),S.register(),customElements.define("pg-app-bar",wt)});let te=wt;function me({alert:o,container:t,hasBorder:e=!0,hasRipple:i=!0,onClick:r=null}){const s=document.createElement(t);return s.className="alert flex row nowrap align-center justify-between",s.style.padding="var(--ui-spacing)",s.style.overflow="hidden",s.style.position="relative",e&&(s.style.borderBottom="1px solid var(--ui-borderColor)"),s.innerHTML=`
...
`);for(let y=0;y<u.length;y++){if(!u[y])continue;let[H,...fe]=u[y].trim().replace(/\t/g," ").split(" ");H=H.trim();const{productName:Ft,format:le,newRest:Ot}=s(fe);if(!le)throw`missing format for "${Ft}" (lotto: "${H}") in vis (txt) data!`;if(!(Ot[0]||"").match(/^[0-9]+[,]?[0-9]*$/))throw`thickness not found for "${Ft}" with lotto "${H}"!`;const be=Ot.shift()||"",ve=Ot.join(" ");c.data.push({lotto:H,name:Ft,format:le,thickness:parseFloat(be.replaceAll(",",".")),stamp:ve})}return c},d=i.name.replace(/\.vis\.txt$/i,"").replace(/\.txt$/i,"").replace(/^vis[_-]/i,""),L=l(d,e);this.uiStore.ui.update("vis",p=>(p.unshift(L),p))})}};n(Ht,"register",()=>{C.register(),m.register(),v.register(),tt.register(),customElements.define("pg-drawer-vis",Ht)});let re=Ht;const pi=a`
    <ui-flex-grid-row>
        <ui-flex-grid-item>
            <ui-button
                style="justify-content: flex-start;"
...
`,qt=class qt extends m{constructor(){super(),this.innerHTML=pi,this.ui={...this.ui,events:new b},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)})),this.cleanup.add(e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title,null)}setText(t,e=null){const i=document.createElement("span");i.innerHTML=a` <ui-primary>${t}</ui-primary> `,e!==null&&(i.innerHTML+=a`<ui-secondary>${e}</ui-secondary>`),this.querySelector("ui-button").appendChild(i)}};n(qt,"regsiter",()=>{M.register(),m.register(),A.register(),k.register(),v.register(),S.register(),T.register(),x.register(),customElements.define("pg-drawer-item-vis-data",qt)});let et=qt;const gi=`
    <ui-flex-grid-item>
        <ui-input
            name="title"
            type="text"
...
`,Nt=class Nt extends Z{constructor(){super(),this.innerHTML=fi}getGroup(t){return this.querySelector(`pg-drawer-${t.toString()}`)}};n(Nt,"register",()=>{Z.register(),ee.register(),ie.register(),re.register(),se.register(),customElements.define("pg-drawer",Nt)});let oe=Nt;const bi=a`
    ...
    <pg-drawer></pg-drawer>
`,zt=class zt extends HTMLElement{constructor(){super(),this.innerHTML=bi,this.cleanup=new h,this.uiStore=this.querySelector("ui-store"),this.createStore(),this.stackLayout=this.querySelector("ui-stack-layout"),this.createStackLayout(),this.pgSearchBar=this.querySelector("pg-search-bar"),this.pgAppBar=this.querySelector("pg-app-bar"),this.pgDrawer=this.querySelector("pg-drawer")}connectedCallback(){this.pgDrawer.ui.setOpen(!0),this.cleanup.add(this.uiStore.ui.on("appBarTitle",this.onAppBarTitle.bind(this),!0)),this.cleanup.add(this.uiStore.ui.on("share",this.onShare.bind(this),!0)),this.setupNoPage()}disconnectedCallback(){this.cleanup.run()}createStore(){this.uiStore.ui.set("alertLists",[],!0),this.uiStore.ui.set("metalSheetLists",[],!0),this.uiStore.ui.set("vis",[],!0),this.uiStore.ui.set("visData",[],!0),this.uiStore.ui.set("appBarTitle","",!1),this.uiStore.ui.set("share",null,!1),this.uiStore.ui.set("search",{active:!1,value:""},!1)}createStackLayout(){this.stackLayout.ui.events.on("change",({newPage:t})=>{if(this.stackLayout.ui.stackSize()>1?this.pgAppBar.itemBack.ui.enable():this.pgAppBar.itemBack.ui.disable(),!t){this.setupNoPage();return}switch(t.ui.getName()){case"alert-lists":this.setupAlertListsPage();break;case"metal-sheet-lists":break;case"vis":break;case"vis-data":break;case"alert":this.setupAlertPage();break;default:this.setupNoPage()}}),this.stackLayout.ui.registerPage("alert-lists",()=>new D),this.stackLayout.ui.registerPage("metal-sheet-lists",()=>new Q),this.stackLayout.ui.registerPage("vis",()=>new I),this.stackLayout.ui.registerPage("vis-data",()=>new G)}setupAlertPage(){this.uiStore.ui.get("search").active&&this.pgAppBar.itemSearch.ui.getItem().click(),this.pgAppBar.itemSearch.ui.disable()}setupAlertListsPage(){this.pgAppBar.itemSearch.ui.enable()}setupNoPage(){this.uiStore.ui.set("appBarTitle","PG: Vis"),this.uiStore.ui.set("share",null),this.uiStore.ui.get("search").active&&this.pgAppBar.itemSearch.ui.getItem().click(),this.pgAppBar.itemSearch.ui.disable()}async onAppBarTitle(t){this.pgAppBar.itemTitle.ui.getItem().innerHTML=t||""}async onShare(t){t!==null?this.pgAppBar.itemShare.ui.enable():this.pgAppBar.itemShare.ui.disable()}};n(zt,"register",()=>{M.register(),$.register(),Ut.register(),A.register(),k.register(),Yt.register(),X.register(),Z.register(),C.register(),m.register(),v.register(),S.register(),T.register(),x.register(),_t.register(),te.register(),oe.register(),D.register(),Q.register(),I.register(),G.register(),customElements.define("pg-app",zt)});let ne=zt;Le({onRegistered(o){setTimeout(async()=>{try{await o.update()}catch(t){console.warn(`Auto update failed: ${t}`)}})}});ne.register();
