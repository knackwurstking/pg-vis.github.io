...
<slot></slot>
`,A=class A extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$G,this.cleanup=new CleanUp,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(A,"register",()=>{customElements.get("ui-container")||customElements.define("ui-container",A)});let UIContainer=A;const content$F=html`
    <style>
        :host {
            width: 100%;
            height: 100%;
...
`,$=class $ extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$F}};a($,"register",()=>{customElements.get("svg-chevron-left")||customElements.define("svg-chevron-left",$)});let SvgChevronLeft=$;const content$E=html`
    <style>
        :host {
            width: 100%;
            height: 100%;
...
`,U=class U extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$E}};a(U,"register",()=>{customElements.get("svg-chevron-down")||customElements.define("svg-chevron-down",U)});let SvgChevronDown=U;const content$D=html`
    <style>
        :host {
            width: 100%;
            height: 100%;
...
`,R=class R extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$A}};a(R,"register",()=>{customElements.get("svg-search")||customElements.define("svg-search",R)});let SvgSearch=R;const content$z=html`
    <style>
        :host {
            width: 100%;
            height: 100%;
...
`,P=class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$z}};a(P,"register",()=>{customElements.get("svg-menu")||customElements.define("svg-menu",P)});let SvgMenu=P;const content$y=html`
    <style>
        :host {
            width: 100%;
            height: 100%;
...
`,q=class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$y}};a(q,"register",()=>{customElements.get("svg-share")||customElements.define("svg-share",q)});let SvgShare=q;const content$x=html`
    <style>
        * {
            box-sizing: border-box;
        }
...
`,w=class w extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$w,this.cleanup=new CleanUp,this.ui={root:this,aside:this.shadowRoot.querySelector("aside"),events:new Events,getOpen(){return this.root.hasAttribute("open")},setOpen(t){t?this.root.setAttribute("open",""):this.root.removeAttribute("open")}}}connectedCallback(){const t=i=>{i.stopPropagation(),this.ui.setOpen(!1)},e=i=>{i.stopPropagation()};this.addEventListener("click",t),this.ui.aside.addEventListener("click",e),this.cleanup.add(()=>{this.ui.aside.removeEventListener("click",e),this.removeEventListener("click",t)})}disconnectedCallback(){this.cleanup.run()}attributeChangedCallback(t,e,i){switch(t){case"open":i!==null?(this.classList.add("open"),this.ui.events.dispatch("open",this)):(this.classList.remove("open"),this.ui.events.dispatch("close",this));break}}};a(w,"register",()=>{customElements.get("ui-drawer")||customElements.define("ui-drawer",w)}),a(w,"observedAttributes",["open"]);let UIDrawer=w;const content$v=html`
    ...
    <slot></slot>
`,V=class V extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$v,this.cleanup=new CleanUp,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(V,"register",()=>{customElements.get("ui-primary")||customElements.define("ui-primary",V)});let UIPrimary=V;const content$u=html`
    <style>
        :host {
            font-size: 0.9rem;
            font-family: var(--ui-fontFamily);
    ...
    <slot></slot>
`,F=class F extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=content$u,this.cleanup=new CleanUp,this.ui={}}connectedCallback(){}disconnectedCallback(){this.cleanup.run()}};a(F,"register",()=>{customElements.get("ui-secondary")||customElements.define("ui-secondary",F)});let UISecondary=F;const content$t=html`
    <style>
        * {
            box-sizing: border-box;
        }
...
`,_=class _ extends UIFlexGridRow{constructor(){super(),this.innerHTML=content$g,this.ui={...this.ui,events:new Events}}connectedCallback(){super.connectedCallback();const t=this.querySelector('[name="new-entry"]'),e=this.querySelector('[name="delete-table"]');this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("new-entry",null)}),e.ui.events.on("click",()=>{this.ui.events.dispatch("delete-table",null)}))}};a(_,"register",()=>{UIFlexGridRow.register(),UIFlexGridItem.register(),UIButton.register(),customElements.define("metal-sheet-actions",_)});let MetalSheetActions=_;const content$f=html`
    <div
        class="no-scrollbar"
        style="
            width: 100%;
...
`,rt=class rt extends UIDialog{constructor(t){super(),this.appendChild((()=>{const e=new UIFlexGrid;return e.ui.setGap("0.5rem"),e.innerHTML=gridContent$2,e})()),this.ui.setTitle(`Import "${t}"`),this.gistID=this.querySelector('ui-input[name="gistID"]'),this.createCancelButton(),this.createSubmitButton()}createCancelButton(){const t=new UIFlexGridItem;t.slot="actions",t.innerHTML=`
            <ui-button variant="full" color="secondary">Cancel</ui-button>
        `,t.querySelector("ui-button").ui.events.on("click",()=>{this.ui.close()}),this.appendChild(t)}createSubmitButton(){const t=new UIFlexGridItem;t.slot="actions",t.innerHTML=`
            <ui-button variant="full" color="primary">Submit</ui-button>
        `,t.querySelector("ui-button").ui.events.on("click",()=>{this.ui.events.dispatch("submit",this.gistID.ui.getValue()||null),this.ui.close()}),this.appendChild(t)}};a(rt,"register",()=>{UIDialog.register(),UIFlexGrid.register(),UIFlexGridItem.register(),UIInput.register(),UIButton.register(),UILabel.register(),customElements.get("import-dialog")||customElements.define("import-dialog",rt)});let ImportDialog=rt;const gridContent$1=html`
    <ui-flex-grid-item>
        <ui-label
...
`,at=class at extends UIDrawerGroupItem{constructor(){super(),this.innerHTML=content$a,this.ui={...this.ui,events:new Events},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)}),e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title)}setText(t){const e=document.createElement("span");e.innerHTML=html` <ui-primary>${t}</ui-primary> `,this.querySelector("ui-button").appendChild(e)}};a(at,"register",()=>{SvgTrash.register(),UIDrawerGroupItem.register(),UIFlexGridRow.register(),UIFlexGridItem.register(),UIButton.register(),UIIconButton.register(),UIPrimary.register(),UISecondary.register(),customElements.define("pg-drawer-item-alert-list",at)});let PGDrawerItemAlertList=at;const storeGistKey$1="alert-lists",content$9=html`
    <drawer-import-button
        store-gist-key="${storeGistKey$1}"
    ></drawer-import-button>
    <drawer-gist-item></drawer-gist-item>
`,lt=class lt extends UIDrawerGroup{constructor(){super(),this.innerHTML=content$9,this.style.position="relative",this.ui.setTitle("Alarm Listen"),this.uiStore=document.querySelector("ui-store"),this.stackLayout=document.querySelector("ui-stack-layout")}connectedCallback(){super.connectedCallback(),this.cleanup.add(this.uiStore.ui.on("gist",this.storeGistHandler.bind(this),!0),this.uiStore.ui.on("alertLists",this.storeAlertListsHandler.bind(this),!0));const t=this.querySelector("drawer-import-button");t.ui.onValidate=this.validate.bind(this),t.ui.onUpdate=this.update.bind(this)}async validate(t,e=null){const i=r=>new Error(`invalid data for alert:
...
`)),s.desc.filter(n=>typeof n!="string").length)||typeof s.note!="string"&&s.note)throw i(s)}return t}async update(t){const e=t.title;if(this.uiStore.ui.get("alertLists").find(i=>i.title===e)){if(!window.confirm(`Replace data: ${t.title}?`))return;this.uiStore.ui.update("alertLists",i=>i.map(r=>r.title===e?t:r));return}this.uiStore.ui.update("alertLists",i=>[...i,t])}async storeGistHandler(t){if(!t)return;const e=this.querySelector("drawer-gist-item"),i=t["alert-lists"];if(!i){e.ui.set(null,null),e.ui.onPull=null,e.ui.onPush=null;return}e.ui.set(i.id,i.revision);let r;const s=()=>{r&&e.removeChild(r),r=new UISpinner,e.appendChild(r)},n=()=>{r&&(e.removeChild(r),r=void 0)};e.ui.onPull=async(l,u)=>{s();try{await gistPull(l,u,{update:this.update,updateRevision:d=>{this.uiStore.ui.update("gist",h=>h[storeGistKey$1]={id:l,revision:d})}})}finally{n()}},e.ui.onPush=async(l,u)=>{s();try{await gistPush(l,u,this.uiStore.ui.get("alertLists"),{getFileName:getFileName$1,updateRevision:d=>{this.uiStore.ui.update("gist",h=>h[storeGistKey$1]={id:l,revision:d})}})}finally{n()}}}async storeAlertListsHandler(t){if(!t)return;const e=[...this.children].slice(2);for(;e.length>0;)this.removeChild(e.pop());for(const i of sortAlertLists(t)){const r=new PGDrawerItemAlertList;r.set(i),r.cleanup.add(r.ui.events.on("click",()=>{this.stackLayout.ui.clearStack(),this.stackLayout.ui.setPage("alert-lists",n=>{n.ui.set(i)}),document.querySelector("pg-drawer").ui.setOpen(!1)}),r.ui.events.on("delete",()=>{confirm(`Delete "${i.title} - ${i.date}`)&&this.uiStore.ui.update("alertLists",s=>s.filter(n=>n.title!==i.title))})),this.appendChild(r)}}};a(lt,"register",()=>{UIDrawerGroup.register(),UIDrawerGroupItem.register(),UIButton.register(),UISecondary.register(),DrawerImportButton.register(),DrawerGistItem.register(),PGDrawerItemAlertList.register(),ImportDialog.register(),PushDialog.register(),customElements.define("pg-drawer-alert-lists",lt)});let PGDrawerAlertLists=lt;const content$8=html`
    <ui-button variant="full" color="secondary">Neu</ui-button>
`,ut=class ut extends UIDrawerGroupItem{constructor(){super(),this.innerHTML=content$8,this.uiStore=document.querySelector("ui-store"),this.ui={...this.ui,root:this,button:this.querySelector("ui-button")}}connectedCallback(){super.connectedCallback(),this.cleanup.add(this.ui.button.ui.events.on("click",()=>this.onClick()))}onClick(){const t=new CreateMetalSheetDialog("create");t.ui.events.on("close",()=>{document.body.removeChild(t)}),t.ui.events.on("submit",e=>{e!==null&&this.uiStore.ui.update("metalSheetLists",i=>[...i,e])}),document.body.appendChild(t),t.ui.open(!0)}};a(ut,"register",()=>{UIDrawerGroupItem.register(),UIButton.register(),CreateMetalSheetDialog.register(),customElements.get("drawer-new-metal-sheet-list-button")||customElements.define("drawer-new-metal-sheet-list-button",ut)});let DrawerNewMetalSheetListButton=ut;const content$7=html`
    <ui-flex-grid-row>
        <ui-flex-grid-item>
            <ui-button
                style="justify-content: flex-start;"
...
`,ct=class ct extends UIDrawerGroupItem{constructor(){super(),this.innerHTML=content$7,this.ui={...this.ui,events:new Events},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)}),e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.format,t.toolID,t.data.press)}setText(t,e,i){const r=document.createElement("span");r.innerHTML=html` <ui-primary>${t}</ui-primary><br />`,r.innerHTML+=html`
            <ui-secondary>
                <span>${e}</span>
                <span>${i>-1?"[P"+i+"]":""}</span>
            </ui-secondary>
        `,this.querySelector("ui-button").appendChild(r)}};a(ct,"register",()=>{SvgTrash.register(),UIDrawerGroupItem.register(),UIFlexGridRow.register(),UIFlexGridItem.register(),UIButton.register(),UIIconButton.register(),UIPrimary.register(),UISecondary.register(),customElements.define("pg-drawer-item-metal-sheet-list",ct)});let PGDrawerItemMetalSheetList=ct;const storeGistKey="metal-sheet-lists",content$6=html`
    <drawer-import-button
...
`,dt=class dt extends UIDrawerGroupItem{constructor(){super(),this.innerHTML=content$5,this.ui={...this.ui,events:new Events},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)}),e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title,null)}setText(t,e=null){const i=document.createElement("span");i.innerHTML=html` <ui-primary>${t}</ui-primary> `,e!==null&&(i.innerHTML+=html`<ui-secondary>${e}</ui-secondary>`),this.querySelector("ui-button").appendChild(i)}};a(dt,"regsiter",()=>{SvgTrash.register(),UIDrawerGroupItem.register(),UIFlexGridRow.register(),UIFlexGridItem.register(),UIButton.register(),UIIconButton.register(),UIPrimary.register(),UISecondary.register(),customElements.define("pg-drawer-item-vis",dt)});let PGDrawerItemVis=dt;const content$4=html`
    <drawer-import-button gist-key="vis" disabled></drawer-import-button>
`,pt=class pt extends UIDrawerGroup{constructor(){super(),this.innerHTML=content$4,this.ui.setTitle("Vis"),this.uiStore=document.querySelector("ui-store"),this.stackLayout=document.querySelector("ui-stack-layout")}connectedCallback(){super.connectedCallback(),this.cleanup.add(this.uiStore.ui.on("vis",this.onVis.bind(this),!0));const t=this.querySelector("drawer-import-button");t.ui.onValidate=this.validate.bind(this),t.ui.onUpdate=this.update.bind(this)}async validate(t,e=null){return t}async update(t){}onVis(t){if(!t)return;const e=[...this.children].slice(1);for(;e.length>0;)this.removeChild(e.pop());for(const i of t){const r=new PGDrawerItemVis;r.set(i),r.cleanup.add(r.ui.events.on("click",()=>{this.stackLayout.ui.clearStack(),this.stackLayout.ui.setPage("vis"),document.querySelector("pg-drawer").ui.setOpen(!1)}),r.ui.events.on("delete",()=>{this.uiStore.ui.update("vis",s=>s.filter(n=>n.title!==i.title))}))}}};a(pt,"register",()=>{UIDrawerGroup.register(),UIDrawerGroupItem.register(),UIButton.register(),DrawerImportButton.register(),PGDrawerItemVis.register(),customElements.define("pg-drawer-vis",pt)});let PGDrawerVis=pt;const gridContent=html`
    <ui-flex-grid-item>
        <ui-input name="title" type="text" title="Vis Data Title"></ui-input>
    </ui-flex-grid-item>
`,gt=class gt extends UIDialog{constructor(){super(),this.appendChild((()=>{const t=new UIFlexGrid;return t.ui.setGap("0.5rem"),t.innerHTML=gridContent,t})()),this.ui.setTitle("New Vis Data"),this.uiStore=document.querySelector("ui-store"),this.name=this.querySelector('[name="title"]'),this.createCancelButton(),this.createSubmitButton()}connectedCallback(){super.connectedCallback(),this.resets()}resets(){this.name&&(this.name.ui.setInvalid(!1),this.name.ui.setValue(""))}createCancelButton(){const t=new UIFlexGridItem;t.slot="actions",t.innerHTML=`
            <ui-button variant="full" color="secondary">Cancel</ui-button>
        `,t.querySelector("ui-button").ui.events.on("click",()=>{this.ui.close()}),this.appendChild(t)}createSubmitButton(){const t=new UIFlexGridItem;t.slot="actions",t.innerHTML=`
            <ui-button variant="full" color="primary">Submit</ui-button>
        `,t.querySelector("ui-button").ui.events.on("click",()=>{if(!this.name.ui.getValue()){this.name.ui.setInvalid(!0);return}this.uiStore.ui.update("visData",i=>(i.unshift({title:this.name.ui.getValue(),data:[]}),i)),this.ui.close()}),this.appendChild(t)}};a(gt,"register",()=>{UIFlexGrid.register(),UIFlexGridItem.register(),UIInput.register(),UIButton.register(),UIStore.register(),UIDialog.register(),customElements.define("new-vis-data-dialog",gt)});let NewVisDataDialog=gt;const content$3=html`
    <ui-flex-grid-row>
        <ui-flex-grid-item>
            <ui-button
                style="justify-content: flex-start;"
...
`,mt=class mt extends UIDrawerGroupItem{constructor(){super(),this.innerHTML=content$3,this.ui={...this.ui,events:new Events},this.data=null}connectedCallback(){super.connectedCallback();const t=this.querySelector("ui-button"),e=this.querySelector("ui-icon-button");this.cleanup.add(t.ui.events.on("click",()=>{this.ui.events.dispatch("click",this.data)}),e.ui.events.on("click",()=>{this.ui.events.dispatch("delete",this.data)}))}set(t){this.data=t,this.setText(t.title,null)}setText(t,e=null){const i=document.createElement("span");i.innerHTML=html` <ui-primary>${t}</ui-primary> `,e!==null&&(i.innerHTML+=html`<ui-secondary>${e}</ui-secondary>`),this.querySelector("ui-button").appendChild(i)}};a(mt,"regsiter",()=>{SvgTrash.register(),UIDrawerGroupItem.register(),UIFlexGridRow.register(),UIFlexGridItem.register(),UIButton.register(),UIIconButton.register(),UIPrimary.register(),UISecondary.register(),customElements.define("pg-drawer-item-vis-data",mt)});let PGDrawerItemVisData=mt;const content$2=html`
...
`,bt=class bt extends UIDrawer{constructor(){super(),this.innerHTML=content$1}getGroup(t){return this.querySelector(`pg-drawer-${t.toString()}`)}};a(bt,"register",()=>{UIDrawer.register(),PGDrawerAlertLists.register(),PGDrawerMetalSheetLists.register(),PGDrawerVis.register(),PGDrawerVisData.register(),customElements.define("pg-drawer",bt)});let PGDrawer=bt;const content=html`
